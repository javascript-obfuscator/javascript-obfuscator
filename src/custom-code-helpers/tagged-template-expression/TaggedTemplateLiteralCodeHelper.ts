...
import { TaggedTemplateLiteralTemplate } from './templates/tagged-template-literal/TaggedTemplateLiteralTemplate';

import { AbstractCustomCodeHelper } from '../AbstractCustomCodeHelper';
import { NodeUtils } from '../../node/NodeUtils';

@injectable()
export class TaggedTemplateLiteralCodeHelper extends AbstractCustomCodeHelper {
    /**
     * @type {string}
     */
    @initializable()
    ...
    protected getCodeHelperTemplate (): string {
        return this.customCodeHelperFormatter.formatTemplate(TaggedTemplateLiteralTemplate(), {
