...
const str = {
    ...
    'Greek': mapRange(unicode['Greek']),
    'Cyrillic': mapRange(unicode['Cyrillic']),
    'Armenian': mapRange(unicode['Armenian']),
    'Hebrew': mapRange(unicode['Hebrew']), //reversed
    'Arabic': mapRange(unicode['Arabic']),
    'Syriac': mapRange(unicode['Syriac']), //all reversed
    ...
    'CJK Radicals Supplement': mapRange(unicode['CJK Radicals Supplement']),
    ...
    'CJK Symbols and Punctuation': mapRange(unicode['CJK Symbols and Punctuation']),
    ...
    'Enclosed CJK Letters and Months': mapRange(unicode['Enclosed CJK Letters and Months']),
    'CJK Compatibility': mapRange(unicode['CJK Compatibility']),
    ...
    'CJK Compatibility Forms': mapRange(unicode['CJK Compatibility Forms']),
