...
describe('BlockStatementSimplifyTransformer', () => {
    describe('Full `BlockStatement` simplify cases', () => {
        describe('No `ReturnStatement`', () => {
            describe('Variant #1: single statement', () => {
                const regExp: RegExp = new RegExp('function foo *\\(\\) *{ *' + 'bar\\(\\); *' + '}');
            ...
            describe('Variant #2: multiple statements', () => {
                ...
                before(() => {
                    const code: string = readFileAsString(
                        __dirname + '/fixtures/full-no-return-multiple-statements.js'
                    );
        ...
        describe('With `ReturnStatement`', () => {
            describe('Variant #1: single statement', () => {
                const regExp: RegExp = new RegExp('function foo *\\(\\) *{ *' + 'return bar\\(\\); *' + '}');
            ...
            describe('Variant #2: multiple statements', () => {
                const regExp: RegExp = new RegExp(
                    'function foo *\\(\\) *{ *' + 'return bar\\(\\), *baz\\(\\), *bark\\(\\); *' + '}'
                );
    ...
    describe('Partial `BlockStatement` simplify cases', () => {
        describe('No `ReturnStatement`', () => {
            describe('Variant #1: single statement', () => {
                const regExp: RegExp = new RegExp(
                    'function foo *\\(\\) *{ *' + 'var _0x([a-f0-9]){4,6} *= *baz\\(\\);' + '}'
                );
                ...
                before(() => {
                    const code: string = readFileAsString(
                        __dirname + '/fixtures/partial-no-return-single-statement.js'
                    );
            ...
            describe('Variant #2: multiple statements', () => {
                ...
                before(() => {
                    const code: string = readFileAsString(
                        __dirname + '/fixtures/partial-no-return-multiple-statements.js'
                    );
        ...
        describe('With `ReturnStatement`', () => {
            describe('Variant #1: multiple statements', () => {
                ...
                before(() => {
                    const code: string = readFileAsString(
                        __dirname + '/fixtures/partial-return-multiple-statements.js'
                    );
