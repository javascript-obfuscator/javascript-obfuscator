...
describe('FunctionControlFlowTransformer', function () {
    ...
    describe('transformNode', () => {
        ...
        describe('Variant #2 - two `control flow storage` nodes: root and inner', () => {
            ...
            const regExp1: RegExp = new RegExp(`\\(function\\(\\) *\\{ *${rootControlFlowStorageNodeMatch}`, 'g');
        ...
        describe('Variant #7 - arrow function expression', () => {
            describe('Variant #1 - arrow function expression with body', () => {
                ...
                before(() => {
                    const code: string = readFileAsString(
                        __dirname + '/fixtures/arrow-function-expression-with-body.js'
                    );
            ...
            describe('Variant #2 - arrow function expression without body', () => {
                ...
                before(() => {
                    const code: string = readFileAsString(
                        __dirname + '/fixtures/arrow-function-expression-without-body.js'
                    );
